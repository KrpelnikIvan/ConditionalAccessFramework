...
.EXAMPLE
    .\Export-CAPolicies.ps1 -TokenMap @{
        'afec80a2-6a8b-4762-8bff-33d0b870d49c' = 'REPLACE-WITH-BREAKGLASS-GROUP-ID'
        '1a81d570-416b-4a68-b443-89cf8b2c51ac' = 'REPLACE-WITH-UNTRUSTED-COUNTRIES-LOCATION-ID'
    }
